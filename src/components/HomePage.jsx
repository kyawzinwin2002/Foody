    ...
    <div className="flex text-center flex-col gap-5 w-screen bg-img h-[600px]  justify-center items-center">
      <form onSubmit={searchHandler} className="relative   flex items-center">
        <input
          ...
          className="w-[280px] md:w-[470px] border-2 h-[25px] md:h-[37px] border-gray-200 rounded-2xl"
        />
        <button
          type="submit"
          className=" hover:bg-[#d02a3a] absolute right-0 z-30 rounded-2xl bottom-[0.6px] text-sm bg-black text-white px-4 py-[2.2px]  md:px-5  md:py-2"
        >
          Search
        </button>
      </form>

    ...
    <div className=" flex flex-col gap-4">
      <div className=" text-center">
        ...
        <p>
          ...
          vitae incidunt excepturi ea veritatis quod similique perspiciatis
          magni necessitatibus blanditiis nobis quidem nam totam voluptates
          ducimus ipsa aliquam voluptas doloremque?{" "}
        </p>
      </div>
      <div className="flex">
